...
prod_bar_bg_img = center_load('prod_bar_bg.png')
prod_bar_img = pyglet.resource.image('prod_bar.png')
...
armory_icon_img = center_load('armory_icon.png')

turret_img = center_load('turret.png')
turret_team_color = center_load('turret_team_color.png')
turret_icon_img = center_load('turret_icon.png')
...
apocalypse_icon_img = center_load('apocalypse_icon.png')
...
centurion_icon_img = center_load('centurion_icon.png')
...
defiler_icon_img = center_load('defiler_icon.png')
...
pioneer_icon_img = center_load('pioneer_icon.png')
...
wyrm_icon_img = center_load('wyrm_icon.png')
