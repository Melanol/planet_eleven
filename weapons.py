...
class Projectile(pyglet.sprite.Sprite):
    def __init__(self, x, y, target_px, target_py, damage, speed, target_obj,
                 img=res.laser_img):
        super().__init__(img, x, y, batch=weapons_batch)
        self.damage = damage
        self.speed = speed
        self.target_x = target_px
        self.target_y = target_py
        x_diff = target_px - x
        y_diff = target_py - y
...
class Zap(pyglet.sprite.Sprite):
    def __init__(self, x, y, target_px, target_py, f_started):
...
class Bomb(pyglet.sprite.Sprite):
    def __init__(self, x, y, target_px, target_py, damage, speed,
                 img=res.bomb_anim):
        super().__init__(img, x, y, batch=weapons_batch)
        self.damage = damage
        self.speed = speed
